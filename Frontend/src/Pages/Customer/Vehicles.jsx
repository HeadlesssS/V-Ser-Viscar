  ...
  return (
    <div className="page">
      ...
      <div className="ph">
        <div>
          ...
          <div className="ph-sub">
            Manage your active garage profile and register new vehicles for
            diagnostics.
          </div>
        </div>
      ...
      {showForm && (
        <div
          className="card mb-3"
          style={{ maxWidth: "600px", animation: "fadeUp 0.3s ease" }}
        >
          <div
          ...
          {error && (
            <div className="badge badge-danger mb-2" style={{ width: "100%" }}>
              {error}
            </div>
          )}
      ...
      {vehicles.length === 0 ? (
        ...
        >
          ...
          <p style={{ marginTop: "8px" }}>
            You must register at least one vehicle to book appointments and run
            AI diagnostics. Click "+ Register Vehicle".
          </p>
        </div>
      ) : (
        <div className="grid">
