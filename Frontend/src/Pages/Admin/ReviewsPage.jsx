...
export default function AdminReviewsPage() {
  ...
  return (
    <div className="page">
      ...
      <div className="ph">
        <div>
          <div className="ph-bc">Admin Panel › Reviews</div>
          <div className="ph-title">Customer Reviews</div>
          <div className="ph-sub">
            View, monitor, and manage all customer reviews.
          </div>
        </div>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          <ExportPdfButton path="/reviews" filename="reviews.pdf" label="Export PDF" />
          <button
            className="btn btn-g"
            onClick={loadReviews}
