...
export default function VendorPage() {
  ...
  const handleDelete = async () => {
    try {
      const res = await fetch(`${API}/vendors/${confirmDelete.id}`, {
        method: "DELETE",
      });
      if (!res.ok) {
        const e = await res.json();
    ...
    <div className="page">
      ...
      <div className="ph">
        <div>
          ...
          <p className="ph-sub">
            Manage all your parts suppliers in one place.
          </p>
        </div>
              ...
              <div key={v.id} className="card">
                ...
                <div className="card-head">
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div
                      className="card-id"
                      style={{ color: "#9c97a3", fontSize: 11 }}
                    >
                ...
                <div className="card-actions">
                  <button
                    ...
                    onMouseLeave={(e) => {
                      ...
                      e.currentTarget.style.color = "#cc1e1e";
                    }}
                  >
                    ✎ Edit
                  </button>
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.borderColor = "#b01818";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = "#cc1e1e";
                      e.currentTarget.style.borderColor = "#cc1e1e";
                    }}
                  >
                    ✕ Delete
                  </button>
          ...
          <div className="form-grid">
            <div className="field">
              ...
              <input
                ...
                required
                placeholder="e.g. AutoParts Global"
              />
            </div>
            <div className="field">
      ...
      >
        <div className="confirm-body">
          ...
          <p className="confirm-text">
            <strong>{confirmDelete?.name}</strong> will be deleted.
          </p>
