...
const empty = { fullName: "", email: "", password: "", phone: "", role: "Customer" };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.message === "Registration successful.") {
                addToast(`Customer ${form.fullName} created. Adding vehicle next…`, 'success');
                setTimeout(() => navigate("/staff/add-vehicle", { state: { email: form.email } }), 700);
            } else {
        ...
        <div className="page">
            ...
            <div className="ph">
                <div>
                    ...
                    <div className="ph-sub">Create a customer account, then attach a vehicle in the next step.</div>
                </div>
            </div>
                    ...
                    <div className="form-grid">
                        <div className="field">
                            ...
                            <input value={form.fullName}
                                ...
                                required placeholder="e.g. Sita Sharma" />
                        </div>
                        <div className="field">
