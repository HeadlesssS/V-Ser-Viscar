...
export default function SalesInvoicePage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      setParts(Array.isArray(pts) ? pts.filter(p => p.isActive !== false) : [])
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await apiJson(`${API}/sales-invoices/${confirmDelete.id}`, { method: 'DELETE' })
  ...
  const customerLabel = c => c.userName || c.user?.name || `Customer #${c.id}`
  ...
  return (
    ...
    <div className="page">
      ...
      <div className="ph">
        ...
        <button type="button" className="btn btn-p" onClick={openCreate}>+ New Sale</button>
                ...
                <div style={{ display: 'flex', alignItems: 'stretch' }}>
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 15, fontWeight: 700, color: '#08060d' }}>
                  ...
                  <div style={{
                    ...
                    flex: 1, padding: '16px 24px', display: 'flex', alignItems: 'center',

                    gap: 28, borderRight: '1px solid #f0f0f0', flexWrap: 'wrap',
                    ...
                    {[
                      ...
                      <div key={lb} style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                        ...
                        <span style={{
                          ...
                          fontSize: 10, color: '#9c97a3', textTransform: 'uppercase',
                        ...
                        <span style={{
                          ...
                          color: lb === 'Payment' ? (inv.isPaid ? '#1a7a3a' : '#b05a00') : '#08060d',
                  ...
                  <div style={{
                    ...
                    alignItems: 'flex-end', justifyContent: 'center', gap: 10, minWidth: 180,
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      {inv.discountAmount > 0 && (
                        ...
                        <div style={{
                          ...
                          fontSize: 11, color: '#9c97a3', textDecoration: 'line-through', marginBottom: 2,
                      ...
                      <div style={{ fontSize: 20, fontWeight: 800, color: '#cc1e1e' }}>
                    ...
                    <div style={{ display: 'flex', gap: 6 }}>
                      ...
                      <button type="button" className="btn btn-g" onClick={() => openDetail(inv)}>View</button>

                      <button type="button" className="btn btn-d" onClick={() => setConfirmDelete(inv)}>Delete</button>
        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            ...
            <div className="field">
              ...
              <label>Staff ID <span style={{ fontWeight: 400, color: '#9c97a3' }}>(optional)</span></label>
          ...
          <div className="field">
            ...
            <div style={{ border: '1px solid #e5e4e7', borderRadius: 8, overflow: 'hidden' }}>
              ...
              <div style={{
                ...
                padding: '8px 12px', background: '#f7f7f8', fontSize: 11, fontWeight: 600,

                color: '#9c97a3', textTransform: 'uppercase',

              }}>

                <span>Part</span><span>Qty</span><span>Unit Price</span><span />
              ...
              {items.map((item, idx) => (
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '8px 12px', borderTop: '1px solid #f0f0f0', alignItems: 'center',
                ...
                >
                  ...
                  <select
                    ...
                    style={{
                      ...
                      padding: '6px 8px', border: '1px solid #e5e4e7', borderRadius: 6,
                  ...
                  <input
                    ...
                    max={item.partId ? parts.find(p => p.id === parseInt(item.partId, 10))?.stockQuantity : undefined}
              ...
              <button
                ...
                style={{
                  ...
                  padding: '8px 12px', background: '#f7f7f8', border: 'none',

                  borderTop: '1px solid #e5e4e7', width: '100%', cursor: 'pointer',

                  fontSize: 12, color: '#6b6375', fontFamily: 'inherit',
          ...
          <div style={{
            ...
            background: '#f7f7f8', borderRadius: 8, padding: '12px 14px',
            ...
            <div style={{
              ...
              borderTop: '1px solid #e5e4e7', paddingTop: 8,
          ...
          <div className="field">
            ...
            <div style={{
              ...
              display: 'flex', background: '#f7f7f8', border: '1px solid #e5e4e7',
      ...
      >
        ...
        {detailLoading ? (
          ...
          <div className="empty-state"><div className="spinner" /><p>Loading invoice…</p></div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="form-grid">
              ...
              {[
                ...
                ['Date', new Date(showDetail.saleDate).toLocaleDateString('en-GB', {
                ...
                <div key={lb} style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  <span style={{
                    ...
                    fontSize: 11, color: '#9c97a3', textTransform: 'uppercase', letterSpacing: '0.5px', fontWeight: 600,
                  ...
                  <span style={{
                    ...
                    color: lb === 'Status' ? (showDetail.isPaid ? '#1a7a3a' : '#b05a00') : '#08060d',
            ...
            <div style={{ border: '1px solid #e5e4e7', borderRadius: 8, overflow: 'hidden' }}>
              ...
              <div style={{
                ...
                padding: '8px 14px', background: '#f7f7f8', fontSize: 11, fontWeight: 600, color: '#9c97a3',
              ...
              {showDetail.items?.map(item => (
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: '10px 14px', borderTop: '1px solid #f0f0f0', fontSize: 13, alignItems: 'center',
                ...
                >
                  ...
                  <span style={{ fontWeight: 700, color: '#cc1e1e', textAlign: 'right' }}>
            ...
            <div className="form-actions">
              ...
              <button type="button" className="btn btn-g" onClick={() => setShowDetail(null)}>Close</button>
      ...
      <Modal open={!!confirmDelete} onClose={() => setConfirmDelete(null)} title="Delete Invoice?">
        ...
        <div className="confirm-body">
          ...
          <p className="confirm-text">
            ...
            Invoice <strong>SAL-{String(confirmDelete?.id || 0).padStart(4, '0')}</strong> will be

            permanently deleted and stock reversed.

          </p>

          <div className="form-actions" style={{ justifyContent: 'center' }}>

            <button type="button" className="btn btn-g" onClick={() => setConfirmDelete(null)}>Cancel</button>

            <button type="button" className="btn btn-d" onClick={handleDelete}>Yes, Delete</button>
