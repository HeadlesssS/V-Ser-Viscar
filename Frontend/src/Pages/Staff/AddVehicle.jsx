  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.message === "Vehicle added successfully.") {
        addToast(
          `Vehicle added for ${selectedCustomer?.userName || "customer"}.`,
          "success",
        );
      ...
      <div className="ph">
        <div>
          ...
          <div className="ph-sub">
            Attach a vehicle record to a registered customer profile.
          </div>
        </div>
      </div>
            ...
            <div className="field" style={{ gridColumn: "1 / -1" }}>
              ...
              {selectedCustomer && (
                <div className="card-id" style={{ marginTop: 6 }}>
                  Phone: {selectedCustomer.phone || "—"} · Loyalty:{" "}
