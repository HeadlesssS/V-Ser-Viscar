    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@sarviscar.com", "admin", "admin123", "Admin" },
                    { 2, "staff@sarviscar.com", "staff", "staff123", "Staff" },
                    { 3, "customer1@example.com", "customer1", "cust123", "Customer" }
                });

            migrationBuilder.InsertData(
                table: "Vendors",
                columns: new[] { "Id", "Address", "Email", "Name", "Phone" },
                values: new object[] { 1, "Kathmandu, Nepal", "vendor@autoparts.com", "Auto Parts Ltd", "9800000099" });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Email", "Name", "Phone", "UserId" },
                values: new object[] { 1, "customer1@example.com", "John Doe", "9800000001", 3 });
