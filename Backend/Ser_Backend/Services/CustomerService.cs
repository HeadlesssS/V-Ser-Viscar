...
namespace Ser_Backend.Services.Implementations
{
    public class CustomerService
    {
        ...
        public async Task<String> AddVehicleAsync(AddVehicleDto dto)
        {
            ...
            await _audit.LogAsync("Create", "Vehicle",
                $"Vehicle added: {vehicle.VehicleNumber} ({vehicle.Brand} {vehicle.Model})",
                entityId: vehicle.Id);
        ...
        public async Task<String> UpdateProfileAsync(int userId, UpdateProfileDto dto)
        {
            ...
            await _audit.LogAsync("Update", "User",
                $"{user.Role} profile updated for {user.Name}",
                userId);
